...
/**
 * Errata Automation state: broker message payload, plus fields added during store phase
 */
export interface ErrataToolAutomationState {
  /**
   * Block present for any kind of messages from ETA.
   */
  kai_state: KaiEtaState;
  broker_msg_body: any;
  /** Message headers */
  broker_extra?: any;
}
...
export interface ArtifactModel {
  ...
  states_eta: ErrataToolAutomationState[];
